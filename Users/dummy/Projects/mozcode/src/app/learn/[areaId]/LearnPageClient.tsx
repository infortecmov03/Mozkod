        ...
        <Card>
            ...
            <CardContent className="space-y-8">
                        ...
                        return (
                          <Label 
                            ...
                            className={cn("flex items-center space-x-3 p-3 rounded-md border transition-colors cursor-pointer", itemClass, {
                              ...
                              'cursor-not-allowed opacity-60': !user
                            })}
                          >
              ...
              <div className="flex flex-col items-end mt-8">
                <Button onClick={() => handleCheckQuiz(quiz)} disabled={!user || Object.keys(selectedAnswers).length !== quiz.questions.length}>
                  Verificar Respostas
                </Button>
                {!user && (
                    <p className="text-xs text-muted-foreground mt-2">{t('LearnPage.quiz_login_required')}</p>
                )}
              </div>
            </CardContent>
        </Card>
