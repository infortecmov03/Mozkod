...
export const lesson: TheoryLesson = {
  id: "html-m20",
  title: "Fase 3: History API: Roteamento de SPAs do Zero",
    ...
    <div class="space-y-12">
      <div class="bg-primary/5 p-8 rounded-[2.5rem] border border-primary/10 shadow-2xl">
        ...
        <p class="text-lg leading-relaxed opacity-90">
          As <strong>SPAs (Single Page Applications)</strong> modernas não recarregam o site ao navegar. Elas utilizam a <strong>History API</strong> para mudar a URL e atualizar o conteúdo dinamicamente, mantendo a fluidez de uma aplicação nativa.
        </p>
      </div>
      ...
      <section class="space-y-6">
        ...
        <p class="text-sm">O método <code>history.pushState()</code> permite adicionar uma entrada no histórico do browser sem disparar um pedido de rede ao servidor.</p>
...
// Altera a URL e guarda o estado
history.pushState(state, title, url);
      ...
      <section class="space-y-8">
        <h3 class="text-2xl font-bold font-headline border-b-2 border-primary/20 pb-2 text-accent">2. O Evento popstate: Reagindo ao Retroceder</h3>
