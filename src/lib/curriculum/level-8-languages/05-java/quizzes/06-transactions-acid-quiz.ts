...
export const quiz: Quiz = {
  id: "jv-mq6",
  title: "Quiz: Transações e ACID no Core Banking",
  passingScore: 80,
  questions: [
    {
      id: "q6_1",
    ...
    },
    {
      ...
      options: [
        "O banco apaga tudo",
        "O banco reverte o estado para o início da transação após uma falha",
        "O banco acelera a query",
        "O banco muda a senha"
      ],
      correctAnswer: 1
    },
    {
