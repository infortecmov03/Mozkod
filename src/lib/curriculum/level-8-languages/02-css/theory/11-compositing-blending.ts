  ...
  content: `<div class="space-y-12">
      <div class="bg-primary/5 p-8 rounded-[2.5rem] border border-primary/10 shadow-2xl">
        ...
        <p class="text-lg leading-relaxed opacity-90">
          Modos de mesclagem (Blending Modes) definem como as cores de um elemento interagem com o que está por baixo dele no ecrã. No nível Master, isto permite criar efeitos visuais complexos, correções de cor e texturas dinâmicas sem carregar imagens pesadas ou usar software de edição externo.
        </p>
      </div>
      ...
      <section class="space-y-6">
        ...
        <p class="text-sm">Dominar a distinção entre os dois contextos de mistura é vital:</p>
        <ul class="space-y-4">
      ...
      <section class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div class="p-4 bg-card border rounded-xl shadow-lg">
            ...
            <p class="text-[10px] opacity-70">Multiplica as cores. O resultado é sempre mais escuro. Perfeito para remover fundos brancos de logos.</p>
          </div>
          <div class="p-4 bg-card border rounded-xl shadow-lg">
            <h4 class="font-bold text-accent mb-2">screen</h4>
            <p class="text-[10px] opacity-70">Oposto do multiply. O resultado é sempre mais claro. Ideal para brilhos e flares.</p>
          </div>
          <div class="p-4 bg-card border rounded-xl shadow-lg">
            <h4 class="font-bold text-accent mb-2">overlay</h4>
            <p class="text-[10px] opacity-70">Mistura complexa que preserva luzes e sombras, aumentando o contraste visual.</p>
          </div>
        </div>
      </section>
      ...
      <section class="bg-primary/5 p-8 rounded-[2rem] border-2 border-dashed border-primary/20 text-center">
        ...
        <p class="text-sm italic opacity-80 max-w-2xl mx-auto">
          "Utilize <code>mix-blend-mode: difference</code> em cursores personalizados para que eles invertam a cor conforme passam por cima de elementos brancos ou pretos, garantindo visibilidade total."
        </p>
      </section>
    </div>`
};