  ...
  content: `
    <div class="space-y-12">
      <div class="bg-primary/5 p-8 rounded-[2.5rem] border border-primary/10 shadow-2xl">
        <h2 class="text-3xl font-bold mb-4 font-headline text-primary">🌈 Cores Perceptualmente Uniformes</h2>
        <p class="text-lg leading-relaxed opacity-90">
          O RGB e o HSL foram desenhados para monitores antigos. O <strong>OKLCH</strong> foi feito para o olho humano. No nível Master, usamos OKLCH para garantir que o contraste seja consistente e para aceder ao gamut de cores P3 de monitores modernos.
        </p>
      </div>
      ...
      <section class="space-y-6">
        ...
        <p class="text-sm">Permite misturar cores nativamente, ideal para criar estados de <i>hover</i> ou variações de tema sem definir novas variáveis.</p>
