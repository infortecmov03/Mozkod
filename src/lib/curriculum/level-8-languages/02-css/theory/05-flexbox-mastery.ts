...
&lt;/div&gt;
      ...
      <section class="space-y-6">
        ...
        <ul class="space-y-2 text-xs">
          ...
          <li><strong>Flex-shrink:</strong> Define se o item pode "esmagar" se não houver espaço.</li>
          <li><strong>Flex-basis:</strong> O tamanho inicial ideal antes do cálculo de crescimento.</li>
        </ul>
      </section>
      ...
      <section class="bg-primary/5 p-8 rounded-[2rem] border-2 border-dashed border-primary/20 text-center">
        ...
        <p class="text-sm italic opacity-80 max-w-2xl mx-auto">
          "Nunca mais use margens manuais para separar itens flex. A propriedade <code>gap</code> lida com o espaçamento sem criar margens indesejadas nas bordas do container."
        </p>
      </section>
    </div>
  `
