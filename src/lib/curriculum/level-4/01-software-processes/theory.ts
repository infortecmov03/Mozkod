...
export const lessons = [
  ...
  ...titles.map((title, i) => ({
    id: `se-t${i + 3}`,
    title: title,
    content: `<div class='space-y-4'><h2 class='text-2xl font-bold'>🏗️ Processos de Software: ${title}</h2><p>Domínio das metodologias que garantem a entrega de software profissional e previsível.</p></div>`,
    quizId: `se-q${i + 3}`
  }))
];
