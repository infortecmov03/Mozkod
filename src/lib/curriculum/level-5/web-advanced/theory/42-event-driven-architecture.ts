...
export const lesson: TheoryLesson = {
    id: "webadv-t42-event-driven-architecture",
    title: "Arquitetura: Orientada a Eventos",
    youtubeVideoId: "i5_8_2pGq8Q",
    content: `
        ...
        <h3>Message Brokers Populares:</h3>
        <ul>
            <li><strong>RabbitMQ:</strong> Um message broker tradicional, maduro e confiável que implementa protocolos como AMQP.</li>
            <li><strong>Apache Kafka:</strong> Originalmente projetado para processamento de streaming de alto throughput, Kafka é usado como um "log de eventos" distribuído. É ideal para sistemas que precisam processar um volume massivo de eventos em tempo real.</li>
            <li><strong>Redis Pub/Sub:</strong> Uma solução mais simples e leve para casos de uso que não exigem as garantias robustas de Kafka ou RabbitMQ.</li>
        </ul>
