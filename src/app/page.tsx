  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative py-24 md:py-32 overflow-hidden flex flex-col items-center justify-center text-center">
        ...
        <div className="container px-4 mx-auto max-w-4xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-primary/20 bg-primary/10 text-primary text-sm font-medium">
            <Zap className="w-3 h-3" />
            <span>Now with AI-Powered Code Reviews</span>
          </div>
          
          <h1 className="font-headline text-5xl md:text-7xl font-bold tracking-tight text-white leading-[1.1]">
            Code Your Future <br />
            <span className="text-primary">In Any Language</span>
          </h1>
          
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Master the most in-demand technical skills with our structured curriculum, 
            built-in code editor, and localized African learning paths.
          </p>
          
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/dashboard">
              <Button size="lg" className="h-14 px-8 text-lg rounded-full font-semibold group shadow-lg shadow-primary/20">
                Start Learning Now
                <ArrowRight className="ml-2 w-5 h-5 transition-transform group-hover:translate-x-1" />
              </Button>
            </Link>
            <Button variant="outline" size="lg" className="h-14 px-8 text-lg rounded-full border-2 hover:bg-secondary">
              View Curriculum
            </Button>
          </div>
        </div>
        ...
        <div className="container px-4 mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-card border hover:border-primary/50 transition-all group">
              ...
              <h3 className="font-headline text-xl font-bold mb-3">Interactive Editor</h3>
            ...
            <div className="p-8 rounded-2xl bg-card border hover:border-primary/50 transition-all group">
              ...
              <h3 className="font-headline text-xl font-bold mb-3">Multi-language</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="p-8 rounded-2xl bg-card border hover:border-primary/50 transition-all group">
              ...
              <h3 className="font-headline text-xl font-bold mb-3">CS Core Concepts</h3>
              <p className="text-muted-foreground leading-relaxed">
