  ...
  return (
    <div className={className}>
      <svg width="100%" height="100%" viewBox="0 0 680 420" role="img" xmlns="http://www.w3.org/2000/svg">
        ...
        <desc>Logo dinâmico que se adapta ao tema claro e escuro</desc>
        <defs>
        ...
        {/* Círculos de Fundo com Cores Dinâmicas */}
        ...
        <g clipPath="url(#circ)">
          ...
          {/* </> CENTRAL */}
          <circle cx="340" cy="238" r="32" className="logo-bg-inner" stroke="url(#grad)" strokeWidth="2.5" filter="url(#softglow)"/>
          ...
          {/* TEXTO CURVADO - DINÂMICO */}
          <text transform="translate(239,279) rotate(-308)" fontFamily="'Segoe UI',Arial,sans-serif" fontSize="13" fontWeight="900" className="logo-text-dynamic" textAnchor="middle">C</text>
          <text transform="translate(251,291) rotate(-316)" fontFamily="'Segoe UI',Arial,sans-serif" fontSize="13" fontWeight="900" className="logo-text-dynamic" textAnchor="middle">O</text>
          <text transform="translate(265,304) rotate(-324)" fontFamily="'Segoe UI',Arial,sans-serif" fontSize="13" fontWeight="900" className="logo-text-dynamic" textAnchor="middle">D</text>
          <text transform="translate(280,313) rotate(-332)" fontFamily="'Segoe UI',Arial,sans-serif" fontSize="13" fontWeight="900" className="logo-text-dynamic" textAnchor="middle">E</text>
          ...
          <text transform="translate(313,325) rotate(-348)" fontFamily="'Segoe UI',Arial,sans-serif" fontSize="13" fontWeight="900" className="logo-text-dynamic" textAnchor="middle">O</text>
          <text transform="translate(331,328) rotate(-356)" fontFamily="'Segoe UI',Arial,sans-serif" fontSize="13" fontWeight="900" className="logo-text-dynamic" textAnchor="middle">R</text>
          <text transform="translate(349,328) rotate(-4)" fontFamily="'Segoe UI',Arial,sans-serif" fontSize="13" fontWeight="900" className="logo-text-dynamic" textAnchor="middle">K</text>
          ...
          <text transform="translate(400,313) rotate(-28)" fontFamily="'Segoe UI',Arial,sans-serif" fontSize="13" fontWeight="900" className="logo-text-dynamic" textAnchor="middle">M</text>
          <text transform="translate(415,304) rotate(-36)" fontFamily="'Segoe UI',Arial,sans-serif" fontSize="13" fontWeight="900" className="logo-text-dynamic" textAnchor="middle">O</text>
